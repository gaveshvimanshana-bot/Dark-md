...
async function connectToWA() {
  ...
  console.log("Connecting Dark md");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("Dark md installed successful ✅");
      console.log("Dark md connected to whatsapp ✅");

      let up = `Dark md connected successful ✅`;
      let up1 = `Hello Dark, I made bot successful`;
      ...
      robin.sendMessage("94789706579@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Dark-Robin/Bot-Helper/refs/heads/main/autoimage/Bot%20robin%20cs.jpg`,
        },
        caption: up1,
